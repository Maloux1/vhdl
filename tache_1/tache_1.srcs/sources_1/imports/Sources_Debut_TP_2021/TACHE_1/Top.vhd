...
signal Clk20: std_logic;                            -- Horloge 25 MHz
...
begin
    ...
    Diviseur_20:   entity work.ClkDiv_20
                port map(
                    clk10M => Clk25,   -- Horloge 100 Mhz
                    reset => Reset_N,   -- Reset Asynchrone
                    clk20 => Clk20      -- Horloge 25 MHz
                );

    -- Contrôleur VGA 4 Bits
    VGA_4bits:        entity work.VGA_4bits
                port map(
                    clk25 => Clk25,         -- Horloge
                    reset => Reset_N,       -- Reset Asynchrone
