...
HD_PWD='C:/Users/UserTP.PPI919/Desktop/vhdl-master/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_baxys.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_baxys.tcl
