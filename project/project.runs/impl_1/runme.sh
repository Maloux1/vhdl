...
HD_PWD='C:/Users/UserTP.PPI919/Desktop/vhdl-master/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_baxys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_baxys.tcl -notrace
